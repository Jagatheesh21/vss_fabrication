...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('store_stocks', function (Blueprint $table) {
            ...
            $table->decimal('inward_material_quantity',16,2);
            ...
            $table->decimal('unit_material_quantity',16,2)->default(0.00);
            $table->decimal('issued_material_quantity',16,2)->default(0.00);
